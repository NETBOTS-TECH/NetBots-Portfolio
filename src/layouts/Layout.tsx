            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <div>
                    <a href="tel:05815940502" className="hover:text-primary transition-colors">05815 940502     </a>
                  </div>
                  <div>
                    <a href="tel:+923475484803" className="hover:text-primary transition-colors">+92 343 3757372</a>
                  </div>
                </li>
                <li className="flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <a href="mailto:info@netbots.io" className="hover:text-primary transition-colors">info@netbots.io</a>
                  </div>
                </li>
              </ul>
            </div>
