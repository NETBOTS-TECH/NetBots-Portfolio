...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
      <Helmet>
        <title>Contact Us - NetBots</title>
        <meta name="description" content="Get in touch with NetBots for innovative software solutions and digital transformation services." />
      </Helmet>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to start your project? Contact us and let's discuss how we can help transform your business.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-3 bg-primary hover:bg-primary-dark rounded-lg transition-colors text-white font-semibold"
                >
                  Send Message
                </button>
              </form>
